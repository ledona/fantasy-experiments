...
TYPE_QB="--player_pos QB
       ...
       --team_stats pts rushing_yds turnovers win pens pen_yds
       --cur_opp_team_stats def_* op_* yds pts turnovers pens pen_yds win"
MAX_CASES_QB=2400
OLS_FEATURES_QB=42

TYPE_WT="--player_pos WR TE
       --player_stats fumbles_lost receiving_* tds
       --team_stats passing_yds pts rushing_yds turnovers win
       --cur_opp_team_stats def_* op_* pens pen_yds win"
MAX_CASES_WT=11500
OLS_FEATURES_WT=34
...
TYPE_D="--team_stats def_* op_* pts yds turnovers pens pen_yds win
      --cur_opp_team_stats passing_yds pts rushing_yds turnovers pens pen_yds win"
MAX_CASES_D=2400
OLS_FEATURES_D=31
...
usage: nfl.sc (QB|WT|RB|D) (OLS|RF|XG|BLE|DNN_RS|DNN_ADA) (dk|fd|y)"
}
...
if [ "$1" == "D" ]; then
    # team defense
    MODEL_ARG="--model_team_stat ${3}_score_def# --extra_stats team_home_H home_C"
else
    # offensive players
    MODEL_ARG="--model_player_stat ${3}_score_off# --extra_stats player_home_H team_home_H home_C"
fi
...
CMD="python -O scripts/meval.sc $SHARED_MEVAL_ARGS -o nfl_${1}_${2} nfl_hist_reg_2009-2018.db
