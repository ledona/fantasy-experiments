...
dumpdata.sc --seasons $SEASONS --no_team --only_starters \
   ...
   --stats off_1b off_2b off_3b off_hr off_hit \
      "off_r*" off_ab off_pa "off_sac*" off_sb off_sb_c \
   ...
   --player_team_stats off_bb off_hit off_hr off_pa off_rbi off_runs \
      off_groundballs off_linedrives off_flyballs \
   --opp_team_stats errors "p_*" "sp_*" "rp_*"\
   --calc_stats "*_score" \
   --current_extra "hitter_*" "team_ops*" "team_slug*" $SHARED_CURRENT_X \
   --current_opp_extra "team_whip*" "sp_*" "bp_*" \
...
dumpdata.sc --seasons $SEASONS --no_team \
   ...
   --stats p_outs p_pc p_bb p_k p_wp p_hbp p_strikes \
      sp_cg sp_qs p_win p_loss \
      p_groundballs p_linedrives p_flyballs \
      p_hits p_runs p_er p_hr \
   --player_team_stats errors off_runs p_runs "rp_save*" rp_hold win \
   --opp_team_stats off_hit off_hr off_runs win \
      off_k off_bb off_pa off_sb \
      off_groundballs off_linedrives off_flyballs \
   --calc_stats "*_score" \
   --current_extra sp_hand elo_win_prob odds_ml days_rest_player "bp_*" $SHARED_CURRENT_X \
...
p_bb p_hits rp_hold p_hr p_k p_pc sp_qs p_runs rp_save rp_save_blown win"
TEAM_CURRENT_X="sp_* bp_* team_hit*side* team_ops* team_slug* team_whip*"
# don't use 2008 because of missing money line data
SEASONS="2009 2010 2011 2012 2013 2014 2015 2016 2017 2018 2019 2020 2021 2022 2023 2024 2025"
dumpdata.sc --seasons $SEASONS --no_player \
   --stats $TEAM_STATS \
   --opp_team_stats $TEAM_STATS \
   --current_extra odds_ml elo_win_prob $SHARED_CURRENT_X $TEAM_CURRENT_X \
